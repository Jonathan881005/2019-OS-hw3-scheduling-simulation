...
int cur;                            //目前ready queue的task數量

task_priority_type pri_running;     //目前Running的 task priority

int task_running;                   //目前Running的 task id

int task_first;                     //Ready queue 第一個task
